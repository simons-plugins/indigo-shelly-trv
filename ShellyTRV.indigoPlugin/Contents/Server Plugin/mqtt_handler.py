#! /usr/bin/env python
# -*- coding: utf-8 -*-
# Generic MQTT handler — copy this file verbatim into generated plugins.
...
class ThreadMqttHandler(threading.Thread):
    """Manages MQTT connection for a coordinator device."""
    ...
    def run(self):
        try:
            self.mqtt_client = mqtt.Client(
                ...
                client_id=f"indigo-plugin-{self.dev_id}-{uuid.uuid4().hex[:8]}",
